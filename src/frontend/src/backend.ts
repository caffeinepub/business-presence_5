...
export class Backend implements backendInterface {
    ...
    async addRating(arg0: string, arg1: bigint, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async deleteRating(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllRatings(): Promise<Array<[bigint, Rating]>> {
        if (this.processError) {
            try {
    ...
    async getAllSubmissions(): Promise<Array<[Time, ContactSubmission]>> {
        if (this.processError) {
            try {
    ...
    async updateRating(arg0: bigint, arg1: string, arg2: bigint, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateRating(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
