...
export const idlService = IDL.Service({
  ...
  'addRating' : IDL.Func([IDL.Text, IDL.Nat, IDL.Text], [IDL.Nat], []),
  'assignCallerUserRole' : IDL.Func([IDL.Principal, UserRole], [], []),
  'deleteRating' : IDL.Func([IDL.Nat], [], []),
  'getAllRatings' : IDL.Func(
      [],
      [IDL.Vec(IDL.Tuple(IDL.Nat, Rating))],
      ['query'],
    ),
  'getAllSubmissions' : IDL.Func(
      [],
      [IDL.Vec(IDL.Tuple(Time, ContactSubmission))],
      ['query'],
    ),
  ...
  'updateRating' : IDL.Func([IDL.Nat, IDL.Text, IDL.Nat, IDL.Text], [], []),
});
